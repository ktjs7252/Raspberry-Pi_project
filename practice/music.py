...
#Frq = [ do, re, mi, pa, sol, la, si, h_do ]
Frq= [(sol,1), (sol,1),(la,1), (la,1), (sol,1), (sol,1), (mi,2), (sol,1), (sol,1), (mi,1), (mi,1) ,(re,4),
...
try:               
    while 1:   
        for fr in Frq:
            p.ChangeFrequency(fr[0])    #주파수를 fr로 변경
            time.sleep(speed*fr[1])     #speed 초 * 쉼표 만큼 딜레이 (0.5s) 
